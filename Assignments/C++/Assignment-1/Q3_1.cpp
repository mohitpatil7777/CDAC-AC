...
int main(){
    ...
    // e1.empId = 999;        // Error: empId is private, cannot access directly outside class scope
    // e1.basicSalary = -1000; // Error: basicSalary is private, modification must go through setBasicSalary() setter
